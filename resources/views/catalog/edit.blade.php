         ...
         <div class="card-body" style="padding:30px">
            ...
            <form action="{{ url('/catalog/edit') }}" method="POST">
	            ...
	            <div class="form-group">
                   ...
                   value="{{$pelicula->title}}" class="form-control">
	            </div>

	            <div class="form-group">
	            	<label for="year">A&ntilde;o</label>
                   <input type="number" name="year" id="year"
                   value="{{$pelicula->year}}" class="form-control">
	            </div>

	            <div class="form-group">
	            	<label for="director">Director</label>
                   <input type="text" name="director" id="director"
                   value="{{$pelicula->director}}" class="form-control">
	            </div>

	            <div class="form-group">
	            	<label for="poster">P&oacute;ster</label>
                   <input type="text" name="poster" id="poster"
                   value="{{$pelicula->poster}}" class="form-control">
	            </div>
